...
with ALL available historical data (including Series 3149)
...
def load_series_data() -> Dict[int, List[List[int]]]:
    ...
    # Series 3141-3149 (from jackpot hunter and user data)
    data = {
        ...
        3149: [[2, 3, 5, 6, 7, 8, 10, 12, 17, 19, 20, 22, 23, 25],
...
def main():
    print("="*80)
    print("SERIES 3150 - BEST ML PREDICTION (UPDATED)")
    ...
    print(f"Training on {len(data)} series (3141-3149)")
    ...
    print("="*80)
    print("🎯 BEST ML PREDICTION FOR SERIES 3150 (UPDATED WITH 3149 DATA)")
    print("="*80)
    print()
