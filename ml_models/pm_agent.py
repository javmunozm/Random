...
- Create/manage specialized agents to improve the prediction system
- Track trends, opportunities, and risks
- Coordinate agent tasks toward the jackpot goal
...
NOTE: Predictions are generated by production_predictor.py using PERF_RANK
(historical performance ranking). PM agent focuses on analysis and improvement,
not prediction ranking (which was tested and found less effective than PERF_RANK).
...
- Like a PM hiring developers for specific tasks
"""
